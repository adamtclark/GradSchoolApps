...
#Introduction
This document is a short outline of some of the steps that can be involved in applying for a PhD program in ecology. These include some tips that I, and folks I've worked with over the years, have found helpful. This is definitely not the only way to go about things - you should always look in to the specifics of any program that you want to apply to. If you have any suggestions for how to improve this document, please let me know!
